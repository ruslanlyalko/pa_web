...
function updateProfile(user){
	...
	$("#profileSkype").val(user.skype);
	$("#profileBirthday").val($.datepicker.formatDate('dd M yy', new Date(user.birthday.time)));
	$("#profileFirst").val($.datepicker.formatDate('dd M yy', new Date(user.firstWorkingDate.time)));
	$("#profileDepartment").parent().addClass("is-dirty");
	$("#profileEmail").parent().addClass("is-dirty");
	$("#profilePhone").parent().addClass("is-dirty");
	$("#profileSkype").parent().addClass("is-dirty");
	$("#profileBirthday").parent().addClass("is-dirty");
	$("#profileFirst").parent().addClass("is-dirty");
